...
`define CYDEV_CHIP_MEMBER_USED 30
...
// PGA_P4_v1_10(DeepSleepOperation=0, Gain=9, OutputBuffer=0, Power=3, Vref_Input=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_P4_v1_10, CY_CONFIG_TITLE=PGA_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_1, CY_INSTANCE_SHORT_NAME=PGA_1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=PGA_1, )
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=0, Power=2, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONFIG_TITLE=Opamp_3, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_3, CY_INSTANCE_SHORT_NAME=Opamp_3, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=Opamp_3, )
...
module top ;
	...
	wire [0:0] tmpOE__VTest_net;
	wire [0:0] tmpFB_0__VTest_net;
	wire [0:0] tmpIO_0__VTest_net;
	wire [0:0] tmpINTERRUPT_0__VTest_net;
	electrical [0:0] tmpSIOVREF__VTest_net;
	...
	cy_psoc3_pins_v1_10
		...
		VTest
		 (.oe(tmpOE__VTest_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VTest_net[0:0]}),
		  .analog({Net_660}),
		  .io({tmpIO_0__VTest_net[0:0]}),
		  .siovref(tmpSIOVREF__VTest_net),
		  .interrupt({tmpINTERRUPT_0__VTest_net[0:0]}),
		  .annotation({Net_95}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__VTest_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VrGnd_net;
	wire [0:0] tmpFB_0__VrGnd_net;
	wire [0:0] tmpIO_0__VrGnd_net;
	wire [0:0] tmpINTERRUPT_0__VrGnd_net;
	electrical [0:0] tmpSIOVREF__VrGnd_net;
	...
	cy_psoc3_pins_v1_10
		...
		VrGnd
		 (.oe(tmpOE__VrGnd_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VrGnd_net[0:0]}),
		  .analog({Net_661}),
		  .io({tmpIO_0__VrGnd_net[0:0]}),
		  .siovref(tmpSIOVREF__VrGnd_net),
		  .interrupt({tmpINTERRUPT_0__VrGnd_net[0:0]}),
		  .annotation({Net_98}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__VrGnd_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam AMux_2.muxin_width = 3;
    defparam AMux_2.init_mux_sel = 3'h0;
