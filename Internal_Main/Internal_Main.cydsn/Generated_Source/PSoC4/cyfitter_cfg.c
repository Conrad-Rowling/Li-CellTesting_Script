...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL4, 0x0005DB00u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB0_OA0_SW, 0x21000048u);
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_SARMUXVPLUS_SW, 0x01000011u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_SARMUXVMINUS_SW, 0x02000000u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_SARMUX_SW_HW_CTRL, 0x00000011u);
...
void AMux_2_Set(uint8 channel)
{
	switch (channel) {
		case 0u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTB1_OA0_SW, (0x04u));
			break;
		case 1u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTB1_CTBBUS_SW, (0x10u));
			CY_SET_REG32((void CYXDATA *)CYREG_CTB1_OA0_SW, (0x08u));
			break;
		default:
			break;
	}
...
void AMux_2_Unset(uint8 channel)
{
	switch (channel) {
		case 0u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTB1_OA0_SW_CLEAR, (0x04u));
			break;
		case 1u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTB1_CTBBUS_SW_CLEAR, (0x10u));
			CY_SET_REG32((void CYXDATA *)CYREG_CTB1_OA0_SW_CLEAR, (0x08u));
			break;
		default:
			break;
	}
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x00000031u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC2), 0x00000031u);
