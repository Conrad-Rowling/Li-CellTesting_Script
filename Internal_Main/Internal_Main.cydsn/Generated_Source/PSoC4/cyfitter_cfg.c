...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB0_OA0_SW, 0x01080080u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB0_OA1_SW, 0x28000000u);
...
void AMux_1_Set(uint8 channel)
{
	switch (channel) {
		case 0u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_OA1_SW, (0x02u));
			break;
		case 1u:
		...
		case 2u:
			...
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_OA1_SW, (0x08u));
			break;
		default:
			break;
	}
...
void AMux_1_Unset(uint8 channel)
{
	switch (channel) {
		case 0u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_OA1_SW_CLEAR, (0x02u));
			break;
		case 1u:
		...
		case 2u:
			...
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_OA1_SW_CLEAR, (0x08u));
			break;
		default:
			break;
	}
