...
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_UUID_128   (0x03u)
 ...
 */
#define CY_BLE_STEPCOUNT_SERVICE_INDEX   (0x00u) /* Index of stepcount service in the cy_ble_customs array */
#define CY_BLE_STEPCOUNT_STEPNUMBER_CHAR_INDEX   (0x00u) /* Index of stepnumber characteristic */
#define CY_BLE_STEPCOUNT_STEPNUMBER_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_STEPCOUNT_SLEEPTIME_CHAR_INDEX   (0x01u) /* Index of sleeptime characteristic */
#define CY_BLE_STEPCOUNT_SLEEPTIME_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CY_BLE_STEPCOUNT_SERVICE_HANDLE   (0x0010u) /* Handle of stepcount service */
#define CY_BLE_STEPCOUNT_STEPNUMBER_DECL_HANDLE   (0x0011u) /* Handle of stepnumber characteristic declaration */
#define CY_BLE_STEPCOUNT_STEPNUMBER_CHAR_HANDLE   (0x0012u) /* Handle of stepnumber characteristic */
#define CY_BLE_STEPCOUNT_STEPNUMBER_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0013u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_STEPCOUNT_SLEEPTIME_DECL_HANDLE   (0x0014u) /* Handle of sleeptime characteristic declaration */
#define CY_BLE_STEPCOUNT_SLEEPTIME_CHAR_HANDLE   (0x0015u) /* Handle of sleeptime characteristic */
#define CY_BLE_STEPCOUNT_SLEEPTIME_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0016u) /* Handle of Client Characteristic Configuration descriptor */
