...
static void ClockInit(void)
{
	...
	Cy_SysClk_PeriphSetFracDivider(CY_SYSCLK_DIV_24_5_BIT, 0u, 390624u, 0u);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG32(CYREG_SAR_MUX_SWITCH0, 0x00000014u);
	CY_SET_REG32(CYREG_SAR_MUX_SWITCH_SQ_CTRL, 0x00000014u);
