...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x11u, 0x07u, 0x4Fu, 0xA7u,
        0x38u, 0x4Eu, 0x82u, 0x17u, 0x8Cu, 0xA7u, 0x55u,
        0x40u, 0x57u, 0xC0u, 0x48u, 0xFEu, 0xFBu, 0x0Eu,
...
static uint8_t cy_ble_attValues[0x20u] = {
    /* Device Name */
    (uint8_t)'B', (uint8_t)'L', (uint8_t)'E', (uint8_t)'_', (uint8_t)'T', (uint8_t)'e', (uint8_t)'s', (uint8_t)'t', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* stepcount */
    { 0x4Fu, 0xA7u, 0x38u, 0x4Eu, 0x82u, 0x17u, 0x8Cu, 0xA7u, 0x55u, 0x40u, 0x57u, 0xC0u, 0x48u, 0xFEu, 0xFBu, 0x0Eu },
    /* stepnumber */
    { 0x24u, 0x97u, 0x7Du, 0xB4u, 0xB7u, 0x0Au, 0xADu, 0x94u, 0x4Eu, 0x42u, 0x1Eu, 0xC5u, 0x51u, 0xB7u, 0x4Fu, 0x33u },
    /* sleeptime */
    { 0x37u, 0x41u, 0x37u, 0x6Eu, 0xEFu, 0x5Fu, 0xE8u, 0xA4u, 0xD8u, 0x4Au, 0x50u, 0x6Du, 0x11u, 0x57u, 0xF3u, 0x7Eu },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Eu] = {
    ...
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* stepcount UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* stepnumber UUID */
    { 0x0004u, (void *)&cy_ble_attValues[24] }, /* stepnumber */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cy_ble_attUuid128[2] }, /* sleeptime UUID */
    { 0x0004u, (void *)&cy_ble_attValues[28] }, /* sleeptime */
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x16u] = {
    ...
    { 0x0012u, 0xB751u /* stepnumber                          */, 0x09120001u /* rd,ntf */, 0x0013u, {{0x0004u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x2902u /* Client Characteristic Configuration */, 0x030A0101u /* rd,wr  */, 0x0013u, {{0x0002u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0014u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0016u, {{0x0010u, (void *)&cy_ble_attValuesLen[11]}} },
    { 0x0015u, 0x5711u /* sleeptime                           */, 0x09120001u /* rd,ntf */, 0x0016u, {{0x0004u, (void *)&cy_ble_attValuesLen[12]}} },
    { 0x0016u, 0x2902u /* Client Characteristic Configuration */, 0x030A0101u /* rd,wr  */, 0x0016u, {{0x0002u, (void *)&cy_ble_attValuesLen[13]}} },
};
