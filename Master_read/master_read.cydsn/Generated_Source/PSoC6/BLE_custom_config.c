...
static const cy_stc_ble_customs_t cy_ble_customs[0x01u] = {
    ...
    /* stepcount service */
    {
        0x0010u, /* Handle of the stepcount service */ 
        {

            /* stepnumber characteristic */
            {
                0x0012u, /* Handle of the stepnumber characteristic */ 
            ...
            /* sleeptime characteristic */
            {
                0x0015u, /* Handle of the sleeptime characteristic */ 
