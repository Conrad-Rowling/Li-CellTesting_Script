...
module SCB_UART_PDL_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("c93315b6-a0eb-4aad-8931-a18ac5aa8c2b/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("c93315b6-a0eb-4aad-8931-a18ac5aa8c2b/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("c93315b6-a0eb-4aad-8931-a18ac5aa8c2b/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module SCB_I2C_PDL_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("cc1f16e9-1ccd-4b8b-bec1-45c5341edbf0/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=7, CaptureInputMasked=3, ClockPrescaler=7, Compare0=999, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=0, Period=65535, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, StopInput=7, StopInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=Timer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer, CY_INSTANCE_SHORT_NAME=Timer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer, )
...
module Scan_ADC_v3_10_3 (
    ...
    defparam SARMUX.input_mode = "00";
    defparam SARMUX.muxin_width = 2;


	cy_clock_v1_0
		#(.id("ec01df68-1723-4e6f-b892-6344095d0482/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module top ;
	...
	wire [0:0] tmpFB_0__Debug2_net;
	wire [0:0] tmpIO_0__Debug2_net;
	electrical [0:0] tmpSIOVREF__Debug2_net;

	cy_mxs40_gpio_v1_0
		#(.id("05342961-3c58-4964-86b2-573af410fed5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		Debug2
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Debug2_net[0:0]}),
		  .io({tmpIO_0__Debug2_net[0:0]}),
		  .siovref(tmpSIOVREF__Debug2_net));


	wire [0:0] tmpFB_0__Debug1_net;
	wire [0:0] tmpIO_0__Debug1_net;
	electrical [0:0] tmpSIOVREF__Debug1_net;

	cy_mxs40_gpio_v1_0
		#(.id("21032849-0914-44c3-92a1-db5f6f2c5c46"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		Debug1
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Debug1_net[0:0]}),
		  .io({tmpIO_0__Debug1_net[0:0]}),
		  .siovref(tmpSIOVREF__Debug1_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("bf82774b-1fe3-4918-90b1-4f94fc9d3cf8"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("ececeba0-a708-4848-9863-beb6d9d7544e"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
    ...
    TCPWM_Counter_PDL_v1_0_2 Timer (
        .capture(1'b0),
        .clock(Net_39),
        .compare(Net_68),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("b97fa209-787e-4820-9636-f526f1bf4a2d"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("88e1185e-026f-485b-b320-16d69944907c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
