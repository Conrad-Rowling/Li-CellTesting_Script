...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e4e26c3c-2308-4413-801f-8126161c9f62"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    Scan_ADC_v3_10_2 ADC_1 (
        ...
        .t_dav(Net_3176),
        .t_fvalid(Net_3177),
        .t_fvinternal(Net_3178[1:0]),
        .t_fvout(Net_3179),
        .vagnd(Net_3180),
        .vinPlus_0(Net_3014));

    SCB_P4_v4_0_3 UART_1 (
        .clock(1'b0),
        .cts_in(1'b0),
        .interrupt(Net_2084),
        .m_miso(1'b0),
