...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB1_OA1_SW, 0x20000100u);
...
void AMux_1_Set(uint8 channel)
{
	switch (channel) {
		...
		case 1u:
			...
			break;
		case 2u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_OA0_SW, (0x40u));
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_CTBBUS_SW, (0x800000u));
			CY_SET_REG32((void CYXDATA *)CYREG_CTB1_OA1_SW, (0x400000u));
			break;
		default:
			break;
	}
...
void AMux_1_Unset(uint8 channel)
{
	switch (channel) {
		...
		case 1u:
			...
			break;
		case 2u:
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_OA0_SW_CLEAR, (0x40u));
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_CTBBUS_SW_CLEAR, (0x800000u));
			CY_SET_REG32((void CYXDATA *)CYREG_CTB1_OA1_SW_CLEAR, (0x400000u));
			break;
		default:
			break;
	}
