...
module Scan_ADC_v3_10_3 (
	...
	cy_psoc3_pins_v1_10
		#(.id("14974151-1d54-4eb6-a590-e4a7fa602432/77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("14974151-1d54-4eb6-a590-e4a7fa602432/d2cd031e-911c-40bc-bbf8-28db941411f9"),
	...
	cy_clock_v1_0
		#(.id("14974151-1d54-4eb6-a590-e4a7fa602432/b6815a07-3ae4-40f3-8790-63c50500bc89"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(2),
		  .period("0"),
		  .is_direct(0),
...
module PGA_P4_v1_10_4 (
	...
	cy_connect_v1_0 cy_analog_virtualmux_1_connect(Net_39, Net_51);
...
// PGA_P4_v1_10(DeepSleepOperation=0, Gain=6, OutputBuffer=0, Power=3, Vref_Input=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_P4_v1_10, CY_CONFIG_TITLE=PGA_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_2, CY_INSTANCE_SHORT_NAME=PGA_2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=PGA_2, )
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("07bd4810-e587-4d2d-b007-b07a8b09132e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("785dd5a1-9e69-41e7-9c39-6e7c7a9c5310"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
