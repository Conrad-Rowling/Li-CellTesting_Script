...
// PGA_P4_v1_10(DeepSleepOperation=0, Gain=6, OutputBuffer=0, Power=3, Vref_Input=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_P4_v1_10, CY_CONFIG_TITLE=PGA_2, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_2, CY_INSTANCE_SHORT_NAME=PGA_2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PGA_2, )
module PGA_P4_v1_10_6 (
    Vin,
    Vout,
    Vref);
    inout       Vin;
...
module top ;
    ...
    PVref_P4_v1_0_4 PVref_1 (
        .Vout(Net_1710));

	wire [0:0] tmpOE__In_plus_net;
	wire [0:0] tmpFB_0__In_plus_net;
	wire [0:0] tmpIO_0__In_plus_net;
	wire [0:0] tmpINTERRUPT_0__In_plus_net;
	electrical [0:0] tmpSIOVREF__In_plus_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("07bd4810-e587-4d2d-b007-b07a8b09132e"),
		  ...
		  .input_buffer_sel(2'b00))
		In_plus
		 (.oe(tmpOE__In_plus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__In_plus_net[0:0]}),
		  .analog({Net_1735}),
		  .io({tmpIO_0__In_plus_net[0:0]}),
		  .siovref(tmpSIOVREF__In_plus_net),
		  .interrupt({tmpINTERRUPT_0__In_plus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpOE__Battery_Plus_net;
	wire [0:0] tmpFB_0__Battery_Plus_net;
	wire [0:0] tmpIO_0__Battery_Plus_net;
	wire [0:0] tmpINTERRUPT_0__Battery_Plus_net;
	electrical [0:0] tmpSIOVREF__Battery_Plus_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("29fa238b-bfdc-4496-9149-9aa5cea28476"),
		  ...
		  .input_buffer_sel(2'b00))
		Battery_Plus
		 (.oe(tmpOE__Battery_Plus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Battery_Plus_net[0:0]}),
		  .analog({Net_1525}),
		  .io({tmpIO_0__Battery_Plus_net[0:0]}),
		  .siovref(tmpSIOVREF__Battery_Plus_net),
		  .interrupt({tmpINTERRUPT_0__Battery_Plus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Battery_Plus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam AMux_1_CYAMUXSIDE_A.muxin_width = 3;
    defparam AMux_1_CYAMUXSIDE_A.init_mux_sel = 3'h0;
    ...
    defparam AMux_1_CYAMUXSIDE_B.muxin_width = 3;
    defparam AMux_1_CYAMUXSIDE_B.init_mux_sel = 3'h0;
	...
	wire [0:0] tmpOE__Battery_Minus_net;
	wire [0:0] tmpFB_0__Battery_Minus_net;
	wire [0:0] tmpIO_0__Battery_Minus_net;
	wire [0:0] tmpINTERRUPT_0__Battery_Minus_net;
	electrical [0:0] tmpSIOVREF__Battery_Minus_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Battery_Minus
		 (.oe(tmpOE__Battery_Minus_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Battery_Minus_net[0:0]}),
		  .analog({Net_1706}),
		  .io({tmpIO_0__Battery_Minus_net[0:0]}),
		  .siovref(tmpSIOVREF__Battery_Minus_net),
		  .interrupt({tmpINTERRUPT_0__Battery_Minus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Battery_Minus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("fbdf060f-e356-4635-b1ce-9b3b81ed3ebe"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
