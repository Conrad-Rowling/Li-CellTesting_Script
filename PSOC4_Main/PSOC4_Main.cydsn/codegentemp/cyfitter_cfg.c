...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_CTB0_OA0_SW, 0x00040080u);
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_ART_CTB0VREF_SW, 0x00000002u);
...
void AMux_1_CYAMUXSIDE_A_Set(uint8 channel)
{
	switch (channel) {
		...
		case 1u:
			...
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_CTBBUS_SW, (0x1000000u));
...
void AMux_1_CYAMUXSIDE_A_Unset(uint8 channel)
{
	switch (channel) {
		...
		case 1u:
			...
			CY_SET_REG32((void CYXDATA *)CYREG_CTB0_CTBBUS_SW_CLEAR, (0x1000000u));
...
void AMux_1_CYAMUXSIDE_B_Set(uint8 channel)
{
	switch (channel) {
		case 0u:
			CY_SET_REG32((void CYXDATA *)CYREG_ART_SARMUXVMINUS_SW, (0x01u));
			break;
		case 1u:
			CY_SET_REG32((void CYXDATA *)CYREG_SAR_MUX_SWITCH0, (0x200000u));
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL2, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL2) | 0x07u));
			break;
		case 2u:
			CY_SET_REG32((void CYXDATA *)CYREG_SAR_MUX_SWITCH0, (0x200000u));
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL2, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL2) | 0x70000u));
			break;
		default:
			break;
	}
...
void AMux_1_CYAMUXSIDE_B_Unset(uint8 channel)
{
	switch (channel) {
		case 0u:
			CY_SET_REG32((void CYXDATA *)CYREG_ART_SARMUXVMINUS_SW_CLR, (0x01u));
			break;
		case 1u:
			CY_SET_REG32((void CYXDATA *)CYREG_SAR_MUX_SWITCH_CLEAR0, (0x200000u));
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL2, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL2) & 0xfffffff8u));
			break;
		case 2u:
			CY_SET_REG32((void CYXDATA *)CYREG_SAR_MUX_SWITCH_CLEAR0, (0x200000u));
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL2, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL2) & 0xfff8ffffu));
			break;
		default:
			break;
	}
